    ...
    <div class="inline-block text-left overflow-hidden shadow-xl transform bg-white rounded-lg align-middle sm:max-w-sm w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
      <form class="px-8 pt-6 pb-8 mb-4">
        ...
        <div class="flex items-center justify-between">
          <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-5"
                  type="button"
                  @click.prevent="register">
            Регистрация
          </button>
          <a @click.prevent="openLogin" class="inline-block align-baseline font-bold text-sm text-indigo-500 hover:text-indigo-800" href="#">
