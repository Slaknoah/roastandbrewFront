  ...
  methods: {
    validateCompany() {
      ...
      return (  this.validations.name
                ...
                && this.validations.zip
                && this.validations.address ) ? true : false;
    },
    ...
    hydrateForm() {
      ...
      this.form.zip       = this.company.zip ?? '';
      this.form.website   = this.company.website ?? '';
      this.form.subscription  = this.company.subscription ?? '';
      ...
      this.form.facebook_url  = this.company.facebook_url ?? '';
      this.form.twitter_url   = this.company.twitter_url ?? '';
      this.form.instagram_url = this.company.instagram_url ?? '';

      if ( this.company.header_image_url ) {
        this.showHeaderPreview = true;
        this.headerPreview = this.company.header_image_url;
      }

      if ( this.company.logo_url ) {
        this.showLogoPreview = true;
        this.logoPreview = this.company.logo_url;
      }
    },
