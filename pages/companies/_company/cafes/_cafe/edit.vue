      ...
      <div class="mt-4 flex justify-between flex-wrap overflow-x-auto pt-2 px-4 sm:px-6 lg:flex-wrap">
        <div class="sm:border md:rounded-lg mt-7.5 sm:p-10 w-full mb-8">
          ...
          <p class="text-md text-gray-700">If you want to edit the company information,
            <nuxt-link class="underline text-blue-500" :to="'/companies/' + company.slug + '/edit'">edit the company here</nuxt-link>
          </p>
        </div>
        ...
        <form class="w-full mx-auto sm:border md:rounded-lg mt-7.5 sm:p-10">
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3 mb-5">
              <label class="block uppercase tracking-wide text-gray-700 text-md font-bold mb-2">Cafe Image</label>
          ...
          <div class="text-gray-700 text-xl font-bold mb-2">Location Information</div>
          <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="text-gray-700 text-xl font-bold mb-4">Drink Options</div>
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              <label class="roast-checkbox-container flex items-center">
                <span class="font-sans-lato text-base">Matcha</span>
                <input type="checkbox" v-model="form.matcha"> <span class="roast-checkmark"></span>
              </label>
            </div>
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              <label class="roast-checkbox-container flex items-center">
                <span class="font-sans-lato text-base">Tea</span>
                <input type="checkbox" v-model="form.tea"> <span class="roast-checkmark"></span>
              </label>
            </div>
          </div>

          <div class="text-gray-700 text-xl font-bold mb-4">Brew Methods</div>
          <div class="flex flex-wrap -mx-3 mb-6">
